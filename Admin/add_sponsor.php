             ...
             <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                     <div class="topbar-item d-none d-md-flex px-2">                        
                            <div>
                                <h4 class="page-title fs-20 fw-semibold mb-0">Season / Sponser</h4>
                            </div>
                     </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form id="myForm" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                     <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="nm">Sponsor name</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                placeholder="sponsor title" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="tp">Sponsor type</label>
                                                <select name="type" value="<?php echo $tp;?>"  id="tp"  class="form-control select2" data-toggle="select2" id="validationCustom06"
                                                    placeholder="Sponsor type" required>
                                                    <option value="">Select</option>
                                                    <option value="Auction Sponso"<?php if($tp == "Auction Sponsor") echo "selected"; ?>>Auction Sponsor</option>
                                            ...
                                            <div class="col-6">
                                                <label class="form-label" for="no">Sponsor number</label>
                                                <input type="text" value="<?php echo $no;?>"  id="no" name="number" class="form-control" id="validationCustom03"
                                                    placeholder="Sponsor number" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-6">
                                                <label class="form-label" for="em">Sponsor email</label>
                                                <input type="text" value="<?php echo $em;?>"  id="em" name="email" class="form-control" id="validationCustom04"
                                                    placeholder="Sponsor email" required>
                                                <div class="invalid-feedback">
                                          ...
                                          <div class="mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="file"  name="profile" id="logo" class="form-control" id="validationCustom05"
